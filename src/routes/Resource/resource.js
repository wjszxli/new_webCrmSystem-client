...
import { Table, Badge, Menu, Dropdown, Icon, Card, Form, Row, Col, Input, Button,
  Select, message,Pagination, Upload, Popover } from 'antd';
          ...
          <Col md={8} sm={24}>
            <FormItem label="类型">
              ...
              <Select style={{ width: '90%' }} placeholder="选择类型搜索">
                ...
                <Option value="地方号">地方号</Option>
                <Option value="垃圾号">垃圾号</Option>
                <Option value="官媒号">官媒号</Option>
